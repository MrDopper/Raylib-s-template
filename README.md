# Raylib-s-template
This is template for Raylib that allows users to use Raylib's library. 
**Note**
The reason why I used this approach was because homebrew kept giving me errors messages. 
...
When the code finally compile download this repository and go to lib folder. Make sure you replace any files in lib folder with your own files which can be found in Raylib4.0.0/src. 
